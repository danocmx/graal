...
public class RAVInstruction {
    ...
    public static class ValueMove extends Base {
         ...
         */
        public final RAValue variableOrConstant;
     ...
     *
     * <p>
     * This move is stripped by the allocator but contains necessary information about which symbol
     * is kept at the location. This usually happens on entry assigned to input registers.
     *
     * <pre>
     * LABEL [rsi|DWORD]
     * v1 = MOVE rsi|DWORD
     ...
     * </pre>
     *
     * The first MOVE instruction is stripped first. This can also happen after an instruction that
     * has predefined output registers, like function calls.
     * </p>
     */
